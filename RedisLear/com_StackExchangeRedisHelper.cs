...
/// </author>
/// </summary>
public static class com_StackExchangeRedisHelper
{
    ...
    private static ILog logger = LogManager.GetLogger(typeof(com_StackExchangeRedisHelper));
    ...
    static com_StackExchangeRedisHelper()
    {
    }
    ...
    private static void MuxerConfigurationChanged(object sender, EndPointEventArgs e)
    {
        ...
        {
            logger.Error("Configuration changed: " + e.EndPoint);
        }
    }
    /// <summary>
    /// 发生错误时
